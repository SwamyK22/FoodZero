...
const ReservationForm = () => {
  return (
    <div className="bg-[#EBF0E4] px-20 mt-10">
      <div className="flex items-center justify-start">
        ...
        <div className="relative -left-20  top-7 ">
          <h1 className="text-3xl font-bold">Make a Reservation</h1>
          <small className="text-[#4D4D4D]">Get in touch with restaurant</small>
        </div>
      </div>
      ...
      <div>
        <form action="">
          ...
          <div >
            <select name="" id="" className="mt-2 p-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          ...
          <div className="w-full flex justify-center py-4  pb-8">
            <button className=" bg-[#5E6600] p-2  text-[#ffff]" type="button">
              Book Now
            </button>
          </div>
        </form>
